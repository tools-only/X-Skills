# For Growth PMs & PLG Practitioners

**Build AI agents that drive 15%+ conversion lift through automated activation, engagement, and monetization flows.**

---

## Your Pain Points

- ❌ Manual analysis of user activation patterns takes days
- ❌ A/B tests run slowly, insights come too late
- ❌ Onboarding flows are static, not personalized
- ❌ Viral loops depend on manual intervention
- ❌ Conversion optimization is reactive, not proactive
...
**Impact:** Convert insights to action in minutes, not days

[See implementation guide →](../QUICK_WINS.md#15-minute-win-activation-analytics)
...
[See step-by-step recipe →](../SKILL_CHAINS.md#recipe-3-plg-growth-engine)
...
monetization_trigger → retention_predictor → growth_experiment_framework
```
...
- 📊 Experiment velocity: 2x faster iteration

**Payback period:** Week 2
...
## PLG Skill Frameworks Included

We've curated 51 PLG skills from leading frameworks:

✅ **Reforge Frameworks** — Activation, retention, monetization
✅ **Product-Led Growth Collective** — Viral loops, onboarding
✅ **OpenView Partners** — PLG benchmarks, best practices
✅ **Elena Verna's Playbooks** — Growth models, experimentation
✅ **Lenny's Newsletter** — User psychology, habit formation

Each skill is battle-tested and based on real growth playbooks.

---

## Next Steps

1. **Quick Win:** Start with activation analytics (15 min)
2. **Explore:** Browse [all PLG skill chains](../SKILL_CHAINS.md)
3. **Community:** Share your growth wins
4. **Scale:** Add more skills as you optimize
...
**Ready to 3x your growth velocity?** Install now and deploy your first agent in 15 minutes.
