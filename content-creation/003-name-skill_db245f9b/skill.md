---
name: git-master
description: "Git expert combining atomic commits, rebase/squash, and history search (blame, bisect, log -S). Use for any git operations requiring structured commit strategies, history rewriting, or code archaeology. Triggers: 'commit', 'rebase', 'squash', 'who wrote', 'when was X added', 'find the commit that'."
---
...
- Non-English characters: N commits
- English only: M commits
- Mixed: K commits

DECISION:
- If non-English >= 50% -> Use that language
...
- Separate test from implementation -> ALWAYS pair
