...
| --------------- | ------------------------------------------------------------------------- | ------------------------------------ |
| Badge row       | `![Step](...?style=for-the-badge) ![Status](...) ![Agent](...)`           | Yes (templates); Advised (artifacts) |
| Collapsible TOC | `<details open><summary><strong>📑 {Contextual Label}</strong></summary>` | Yes (templates); Advised (artifacts) |
| Attribution     | `> Generated by {agent} agent \| {date}`                                  | Yes (templates); Advised (artifacts) |
| Nav table       | `<div align="center">\| ⬅️ Previous \| 📑 Index \| Next ➡️ \|</div>`      | Yes (templates); Advised (artifacts) |
