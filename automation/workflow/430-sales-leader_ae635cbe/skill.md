# For Sales Leaders & RevOps Teams

**Build AI agents that save $20K-$40K/month by automating lead qualification, deal inspection, and pipeline management.**

---

## Your Pain Points

- ❌ Sales reps spend 60% of time on admin work instead of selling
- ❌ Manual lead qualification takes 2-3 hours per lead
- ❌ Pipeline forecasts are unreliable and time-consuming
- ❌ Lost deals have no post-mortem analysis
- ❌ Inconsistent qualification frameworks across team
...
[See implementation guide →](../QUICK_WINS.md#15-minute-win-lead-scoring)
...
[See step-by-step recipe →](../SKILL_CHAINS.md#recipe-1-sales-deal-qualification-pipeline)
...
commission_calculator → board_reporting
```
...
- Commission calculations and quota tracking
...
10. **territory_optimizer** — Data-driven territory planning and balancing

[Browse all 156+ Sales/RevOps skills →](../directory.md)
...
- 📊 Win rate: Improved from 18% to 25%
...
- Measure time savings and pipeline quality
...
1. **Quick Win:** Start with lead scoring (15 min)
2. **Explore:** Browse [all sales skill chains](../SKILL_CHAINS.md)
3. **Community:** Share your results and get help
4. **Scale:** Add more skills to your chain as you grow
...
**Ready to save $20K-$40K/month?** Install now and deploy your first agent in 15 minutes.
