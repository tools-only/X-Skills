...
- `CTriggerPush_vtable.{platform}.yaml` - Generated by `/find-CTriggerPush_vtable` or `/write-vtable-as-yaml`
- `CBaseEntity_Touch.{platform}.yaml` - Contains vtable index for Touch
