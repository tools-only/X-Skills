...
**ContextForge** is an AI gateway that unifies tools, agents, models, and APIs — providing MCP federation, LLM proxy, agent routing, rate limiting, auth, caching, and an HTMX-powered Admin UI.
