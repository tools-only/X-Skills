...
For more information about using tools with extended thinking, see our [extended thinking guide](/docs/en/build-with-claude/extended-thinking#extended-thinking-with-tool-use). </Note>
