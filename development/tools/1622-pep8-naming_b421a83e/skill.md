...
This documentation file contains references for all rules in the N: pep8-naming Rules family. For detailed information about specific rules, refer to the [Official Ruff Documentation](https://docs.astral.sh/ruff/rules/).
...
```bash
ruff rule --all | grep "^# pep8-naming"
```
