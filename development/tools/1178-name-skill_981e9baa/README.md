...
|----------|-------|
| **Name** | Skill |
| **Repository** | [frmoretto/hardstop](https://raw.githubusercontent.com/frmoretto/hardstop/main/.claude/skills/hs/SKILL.md) (⭐ 16) |
| **Original Path** | `.claude/skills/hs/SKILL.md` |
| **Category** | development |
| **Subcategory** | tools |
| **Tags** | development |
| **Created** | 2026-02-11 |
| **Updated** | 2026-02-17 |
| **File Hash** | `981e9baad55e9fcd...` |
...
*Source: [frmoretto/hardstop](https://raw.githubusercontent.com/frmoretto/hardstop/main/.claude/skills/hs/SKILL.md)*
