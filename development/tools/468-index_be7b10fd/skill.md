...
## All Slash Commands (19 commands + 5 core skills)

| Command | Purpose |
|---------|---------|
| `/auto` | **Toggle autonomous mode** — controls hook enforcement, auto-approval, checkpoint gates |
...
| `health` | /health, "system health", "check health" |
| `audit` | /audit, "audit installation", "check permissions" |
...
| [Cloud Command Guard](hooks/cloud-command-guard.md) | Cloud CLI security hook |
| [Cloud Guard Testing](hooks/cloud-guard-testing.md) | Testing the cloud guard |
