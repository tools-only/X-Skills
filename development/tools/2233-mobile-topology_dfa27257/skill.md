...
| App ID (iOS) | `[com.example.yourapp]` |
| App ID (Android) | `[com.example.yourapp]` |
...
# Filter by app name: "[your-app-name]"
# Look for:
# - Native crashes
# - Memory warnings
# - Network errors
...
| Backend API | `[https://api.example.com]` | Backend service |
...
3. Launches app via deep link: `exp+[your-app-slug]://expo-development-client/?url=http://localhost:8081`
...
xcrun simctl openurl booted "exp+[your-app-slug]://expo-development-client/?url=http://localhost:8081"
...
Example: `exp+[your-app-slug]://expo-development-client/?url=http://localhost:8081`
