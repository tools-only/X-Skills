...
This guide uses a **forked Maestro** at `olivier-motium/Maestro` with critical fixes for MCP functionality:
...
```bash
cd ~
git clone https://github.com/olivier-motium/Maestro.git maestro-fork
cd maestro-fork
...
```json
{
  "mcpServers": {
    "maestro-oli4-mcp": {
      "command": "/Users/YOUR_USERNAME/maestro-fork/maestro-cli/build/install/maestro/bin/maestro",
      "args": ["mcp"],
      "env": {}
    }
  }
