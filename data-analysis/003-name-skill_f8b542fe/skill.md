...
description: |
  Cte Query Builder - Auto-activating skill for Data Analytics.
...
- Provides step-by-step guidance for cte query builder
...
- "Help me with cte query builder"
- "Set up cte query builder"
- "How do I implement cte query builder?"
